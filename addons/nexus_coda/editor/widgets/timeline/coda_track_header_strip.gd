...
func build_ui(
	...
	CodaControlSizeCompatScript.set_custom_maximum_size(self, Vector2(4000, row_height))
	...
	CodaControlSizeCompatScript.set_custom_maximum_size(_name_edit, Vector2(100000, 30))
